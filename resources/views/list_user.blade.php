...
<style>
    ...
    body {
        ...
        background-image: url('assets/img/WhatsApp Image 2024-09-27 at 22.19.23.jpeg');
        background-size: cover;
        background-position: center;
        background-repeat: no-repeat;
    }

    /* Tambahkan margin-top pada kontainer tabel untuk membuat daftar pengguna lebih ke bawah */
    .table-container {
    ...
    table {
        width: 80%; /* Mengurangi lebar tabel menjadi 80% */
        margin: 20px auto; /* Tabel berada di tengah dengan margin otomatis */
    ...
    th, td {
        padding: 10px; /* Mengurangi padding untuk membuat tabel lebih ringkas */
        text-align: left;
    ...
    /* Styling untuk tombol Tambah User */
    .btn-add {
        padding: 10px 15px; /* Ukuran tombol tambah sedikit lebih kecil */
        background-color: grey;
        color: white;
        text-decoration: none;
        border-radius: 5px;
        font-size: 14px; /* Ukuran font tombol tambah lebih kecil */
        transition: background-color 0.3s;
    ...
    /* Flex container untuk heading dan tombol */
    .table-header {
        display: flex;
